...
function tablaHtmlEmail(cells) {
    ...
    m += "<table width='100%' border='0' cellspacing='0' cellpadding='0' style='background:#fafbfc' bgcolor='#fafbfc' align='center'>"
        ...
        + "<span style='font-size:12px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:rgb(153,153,153)'> "+$('#txt_nombre_').val()+" enviamos la solicitud de los vuelos seleccionado en nuestro punto de venta</span>"
        + "</div>"
        + "</td>"
        + "</tr>"
        + "</thead>"
